        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SwiftCode = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankAccounts_ClientAccount",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TradingAccounts_ClientAccount",
                        column: x => x.ClientAccountId,
                        principalTable: "ClientAccount",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_ClientAccount",
                        column: x => x.ClientAccountId,
                        principalTable: "ClientAccount",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccount_ClientAccountId",
                table: "BankAccount",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TradingAccount_ClientAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserApplication_ClientAccountId",
